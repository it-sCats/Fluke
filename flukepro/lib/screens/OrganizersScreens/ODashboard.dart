...
class Odashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GridView.count(//حيعطينا التقسيمة للشاشة
        shrinkWrap: true,
        mainAxisSpacing: 20,
        crossAxisSpacing: 50,
        crossAxisCount: defaultTargetPlatform == TargetPlatform.android ||
                defaultTargetPlatform == TargetPlatform.iOS//في حال استخدام الموبايل يتم عرض حدث واحد ف كل صف
            ? 1
            : 2,//في حال إستخدام الديسكتوب يتم عرض 2 أحداث فس الصف الواحد
        children: [
          dashboardSection('الأحداث الحالية ', getOngoing()),
