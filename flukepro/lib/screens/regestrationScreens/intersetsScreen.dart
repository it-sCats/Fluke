          ...
          child: Align(
            ...
            SizedBox(height: 30,),
                ...
                Padding(
                  ...
                  child: multiSelectChip(interesets,onSelectionChanged: (selectedList){
                    setState(() {
...
selectedShadowColor: Colors.white,
  ...
  onSelected: (selected) {
  setState(() {//to make it multi selection if selected item is the item that is already selcted it will be removed else will be add to list of selections
