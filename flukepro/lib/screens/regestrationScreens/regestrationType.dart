                ...
                Row(
                  ...
                  children: [
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            height: 160,
                            child: Image.asset(
                                'images/The Little Things StandingCard.png'),
                            decoration: BoxDecoration(
                                border: Border.all(color: conBlack),
                    ...
                    InkWell(
                      onTap: () async {
                        userTypeShared = await SharedPreferences.getInstance();
                        userTypeShared?.setString("userType", '1');
                        Navigator.pushNamed(context, '/OrganizSign');
                      }, //Organizers
                      child: Column(
                        children: [
                          Container(
                            ...
                            height: 160,
                            child: Image.asset(
                                'images/The Little Things Home Officecard.png'),
                            decoration: BoxDecoration(
                                border: Border.all(color: conBlack),
                                borderRadius: BorderRadius.circular(25)),
                          ),
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        height: 160,
                        child:
                            Image.asset('images/The Little Things Working.png'),
                        decoration: BoxDecoration(
                            border: Border.all(color: conBlack),
                            borderRadius: BorderRadius.circular(25)),
                      ),
